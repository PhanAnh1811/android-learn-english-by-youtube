...
public class VideoEnglishYoutubeAdapter1 extends BaseAdapter  {
    private Context context;
    private  int layout;
    private List<VideoEnglishYoutube> videoEnglishYoutubeList;
    private ArrayList<VideoEnglishYoutube> arrayList;

    public VideoEnglishYoutubeAdapter1(Context context, int layout, List<VideoEnglishYoutube> videoEnglishYoutubeList) {
    ...
    public VideoEnglishYoutubeAdapter1(Context context, List<VideoEnglishYoutube> videoEnglishYoutubeList) {
        this.context = context;
        this.videoEnglishYoutubeList = videoEnglishYoutubeList;
    }
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if(view==null){
            ...
            view= inflater.inflate(R.layout.sub_item_listview,null);
